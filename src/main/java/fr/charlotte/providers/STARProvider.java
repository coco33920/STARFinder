...
public class STARProvider implements Provider {
    ...
    public void configureTables() {
        ...
        String statements = "create table if not exists star_rennes(id integer constraint id primary key autoincrement, name text, aller_id text, retour_id text, other_ways text);";
        try {
